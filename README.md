...
|                                                                                                                                                                                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img src="src/main/resources/whatsnew/v2.5.0/slide-language-overrides.png" width="360"><br><img src="src/main/resources/whatsnew/v2.5.0/slide-project-overrides.png" width="360"> | **Accent control** — decide exactly where your accent color appears: scrollbars, links, caret line, search highlights, progress bars, bracket matches, inlay hints, tag matches. Eight independent switches. **Accent rotation** — automatic preset cycling or contrast-aware random. **Per-project** and **per-language** accent pins — bind a color to a specific project or language (Kotlin → cyan, Python → gold); the focus-swap kicks in instantly. Settings shows a live **language-proportions** breakdown of the current project so you know which pin will take effect, with a **Rescan Project Language** action to refresh on demand. **Language override diagnostics** explain detected, polyglot, forced-language, and project-fallback decisions without changing the default dominance logic. **Peacock-parity chrome tinting** — when a pin fires, every chrome surface (status bar, nav bar, tool stripes, panel borders) tints automatically with that accent; WCAG-aware foreground keeps text readable at any saturation. **Accent from project icon** — when enabled, projects without a pin automatically take their accent from the project icon (`.idea/icon.png`) on open. |
...
| ![Font presets](assets/feature-font.png)                                                                                                                                          | **Font presets** — 4 curated Nerd Fonts (Whisper, Ambient, Neon, Cyberpunk) with one-click apply, live preview, and per-preset fine-tuning. **Install, delete, or reinstall fonts** directly from Settings with a consent dialog before any filesystem change.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ![Workspace settings](assets/feature-workspace.png)                                                                                                                               | **Workspace** — auto-fit or fixed width for Project View, Commit, and Git panels with min/max bounds. **Git panel splitter** auto-resizes the branches and file-changes trees. Hide the filesystem path and scrollbar from Project View. Commit Panel path display can move full paths to tooltips or shorten leading directories inline.                                                                                                                                                                                                                                                                                                                                                                                                              |
...
**Quick-Switcher Widget** — a chip in the main toolbar reflects your current accent. Left-click opens a popup with variant + Islands UI toggle, the accent grid, related toggles (Chrome tinting, Glow, Accent rotation, Follow system), and quick actions (Pin, Random, Lighter, Darker, Copy Hex). Right-click opens the same quick actions in a keyboard-friendly context menu. Hide the widget from *Settings → Ayu Islands → General* if you prefer a cleaner toolbar.
...
**Syntax tuning** — *Settings → Ayu Islands → Syntax* gives Pro users per-language sliders for declarations, identifiers, keywords/docs, literals, and operators. Each primitive also has a compact **Bold / Italic** emphasis control that layers on top of its inherited Color Scheme style. Add global readability controls — **Dim comments**, **Soften documentation**, **Quiet operators**, **Emphasize declarations** — when you want dense code to breathe without editing individual Color Scheme keys.
