...
| ![Accent settings](assets/feature-accent.png)           | **Accent control** — decide exactly where your accent color appears: scrollbars, links, caret line, search highlights, progress bars, bracket matches, inlay hints, tag matches. Eight independent switches. **Accent rotation** — automatic preset cycling or contrast-aware random. **Per-project** and **per-language** accent pins — bind a color to a specific project or language (Kotlin → cyan, Python → gold); the focus-swap kicks in instantly. |
